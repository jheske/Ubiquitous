...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            Uri builtUri = uriBuilder.appendQueryParameter(FORMAT_PARAM, format)
                    ...
                    .appendQueryParameter(APPID_PARAM, ApiKey.getApiKey())
                    .build();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                //Send the first result in the list to the wearable
                if (i == 0) {
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            Log.i(LOG_TAG,"configurePeriodicSync");
    ...
    public static Account getSyncAccount(Context context) {
         ...
         */
            if (!accountManager.addAccountExplicitly(newAccount, "", null)) {
                Log.d(LOG_TAG,"getSyncAccount FAILED to add account explicitly");
                return null;
            }
            /*
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        Log.i("SunshineSyncAdapter","onAccountCreated");
        /*
    ...
    public static void initializeSyncAdapter(Context context) {
        Log.i("SunshineSyncAdapter","initializeSyncAdapter");
    ...
    static private void setLocationStatus(Context c, @LocationStatus int locationStatus) {
        ...
        //If on UI thread, use apply() instead of commit()
        spe.commit();
    }
}